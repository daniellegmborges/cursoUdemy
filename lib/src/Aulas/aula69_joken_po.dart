...
class _JogoState extends State<Jogo> {
  ...
  void _opcaoSelecionada(String escolhaUsuario) {
    ...
    switch (escolhaApp) {
      case "pedra":
        setState(() {
          this._imagemApp = AssetImage("images/JokenPo/pedra.png");
        });
        break;
      case "papel":
        setState(() {
          this._imagemApp = AssetImage("images/JokenPo/papel.png");
        });
        break;
      case "tesoura":
        setState(() {
          this._imagemApp = AssetImage("images/JokenPo/tesoura.png");
        });
        break;
    }
